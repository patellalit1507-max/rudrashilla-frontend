  ...
  return (
    <div className="fixed bottom-6 right-4 z-50 flex flex-col items-center gap-3">
      ...
      <a
        href={`tel:+${PHONE}`}
        aria-label="Call us"
        className="flex size-13 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg ring-2 ring-white transition-transform hover:scale-110 active:scale-95"
      >
